...
cd im-cam
git checkout claude/integrate-camera-stream-WxpBn
```
...
├── tunnel.js          ← Module tunnel Cloudflare/ngrok
...
| Ressource | Lien |
|-----------|------|
| Code source | `https://github.com/bernardfreddy0-fbm/HOME` (branche `claude/integrate-camera-stream-WxpBn`) |
